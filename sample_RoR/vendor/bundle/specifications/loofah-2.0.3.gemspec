...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.rdoc".freeze, "MIT-LICENSE.txt".freeze, "Manifest.txt".freeze, "README.rdoc".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rr>.freeze, ["~> 1.1.0"])
      ...
      s.add_dependency(%q<rr>.freeze, ["~> 1.1.0"])
