...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["History.txt".freeze, "MIT-LICENSE.txt".freeze, "README.markdown".freeze]
  s.files = ["History.txt".freeze, "MIT-LICENSE.txt".freeze, "README.markdown".freeze]
